...
const (
	Stats_RecordNo_FullMethodName = "/stats.Stats/RecordNo"
...
type StatsClient interface {
	RecordNo(ctx context.Context, in *RecordRequest, opts ...grpc.CallOption) (*RecordResponse, error)
...
func (c *statsClient) RecordNo(ctx context.Context, in *RecordRequest, opts ...grpc.CallOption) (*RecordResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RecordResponse)
	err := c.cc.Invoke(ctx, Stats_RecordNo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *statsClient) GetStats(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*StatsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type StatsServer interface {
	RecordNo(context.Context, *RecordRequest) (*RecordResponse, error)
...
func (UnimplementedStatsServer) RecordNo(context.Context, *RecordRequest) (*RecordResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RecordNo not implemented")
}
func (UnimplementedStatsServer) GetStats(context.Context, *emptypb.Empty) (*StatsResponse, error) {
...
func _Stats_RecordNo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RecordRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StatsServer).RecordNo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Stats_RecordNo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StatsServer).RecordNo(ctx, req.(*RecordRequest))
	}
...
var Stats_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "RecordNo",
			Handler:    _Stats_RecordNo_Handler,
		},
		{
			MethodName: "GetStats",
